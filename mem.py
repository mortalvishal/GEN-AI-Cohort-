...
def chat(message):
    ...
    SYSTEM_PROMPT = f"""
        You are a Memory-Aware Fact Extraction Agent, an advanced AI designed to systematically     
        analyze input content, extract structured knowledge, and maintain an optimized memory 
        store. Your primary function is information destillation and knowledge preservation with 
    ...
    result = openai_client.chat.completion.create(
        model="gpt-4.1",
        messages = messages
    )
